...
from .helpers import _load_tiger, validate_county, validate_state


def roads(
    state, county, year=None, cache=False, subset_by=None, protocol="http", timeout=1800
):
    """
    ...
    county : str or list
        The county name or three-digit FIPS code of the desired county, or a list of
        such counties.
    year : int
...
def primary_secondary_roads(
    state, year=None, cache=False, subset_by=None, protocol="http", timeout=1800
):
    """
