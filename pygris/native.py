...
def native_areas(
    cb=False, year=None, cache=False, subset_by=None, protocol="http", timeout=1800
):
    """
    Load an American Indian / Alaska Native / Native Hawaiian areas shapefile into
    Python as a GeoDataFrame
    ...
    geopandas.GeoDataFrame
        A GeoDataFrame of American Indian / Alaska Native / Native Hawaiian areas.


    Notes
    -----
    See https://www2.census.gov/geo/pdfs/reference/GARM/Ch5GARM.pdf for more
    information.
...
def tribal_subdivisions_national(
    cb=False, year=None, cache=False, subset_by=None, protocol="http", timeout=1800
):
    """
    Load an American Indian Tribal Subdivision National shapefile into Python as a
    GeoDataFrame
...
def alaska_native_regional_corporations(
    cb=False, year=None, cache=False, subset_by=None, protocol="http", timeout=1800
):
    """
    ...
    if cb:
        ...
        url = (
            f"https://www2.census.gov/geo/tiger/TIGER{year}/ANRC/tl_{year}_02_anrc.zip"
        )
